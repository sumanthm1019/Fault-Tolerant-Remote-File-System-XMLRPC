...
class SimpleHT:
  ...
  def put(self, key, value, ttl):
    # Remove expired entries
    self.check()
    print "KEY in PUT", key
    print "KEY>DATA in PUT", key.data
    print "datetimenow" , datetime.now()
    print "timedelta", timedelta(seconds = ttl)
...
def serve(port):
  file_server = SimpleXMLRPCServer.SimpleXMLRPCServer(('', int(port)))
